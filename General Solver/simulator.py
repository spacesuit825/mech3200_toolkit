...
spring1 = comp.Spring(parent = point, k = sp.symbols('K_1'), length = sp.symbols('L_1'))
mass1 = comp.PointMass(parent = spring1, mass = sp.symbols('m_1'))

# Add the objects to the scene
sim.add_objects([point, spring1, mass1])
